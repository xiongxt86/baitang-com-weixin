...
public class JsonUtils {
	...
	public static JSON toJson(Object bean, String[] excludes,
			String datePattern) throws Exception {
		String pattern = null;
	 ...
	 public static Map<String, Object> json2Map(String jsonStr,String[] excludes){
	        ...
	        for(Object k : json.keySet()){
	            ...
	            if(v instanceof JSONArray){
	                ...
	                while(it.hasNext()){
	                    ...
	                    list.add(json2Map(json2.toString(),excludes));
	                }
	                map.put(k.toString(), list);
	            } else {
	                map.put(k.toString().toUpperCase(), v);
	            }
	        }
	        return map;
	    }
	...
	public static JSON  toJson(Object bean, String excludes,
		...
		if (excludes == null) {
			...
			return JsonUtils.toJson(bean,  excludes.split(","), datePattern);
		}
	}
	 ...
	 * @throws Exception
	 */
	public static void write(Object bean, Writer writer,String datePattern) throws Exception {
		JsonUtils.write(bean, writer,new String[] { "hibernateLazyInitializer" }, datePattern);
	}
	public static JSON toJson(Object bean,String datePattern) throws Exception {
		return JsonUtils.toJson(bean,new String[] { "hibernateLazyInitializer" }, datePattern);
	}
	...
	public static JSON toJson(Object bean) throws Exception {
		return JsonUtils.toJson(bean,
				new String[] { "hibernateLazyInitializer" }, "yyyy-MM-dd");
	}
	...
	public static <T extends Object> T json2Bean(JSONObject jsonObject,
		...
		Map<String, Field> fields = ReflectUtil.getFields(entity.getClass());
	...
	public static String xmlToJson(String xml){
			if(!StringUtile.isEmptyString(xml)){
